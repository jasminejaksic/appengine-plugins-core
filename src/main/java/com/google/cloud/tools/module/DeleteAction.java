...
public class DeleteAction extends Action {
  ...
  public DeleteAction(List<String> modules, String version, Map<Option, String> flags) {
    ...
    ProcessCaller processCaller = new ProcessCaller(Tool.GCLOUD, arguments, flags);
