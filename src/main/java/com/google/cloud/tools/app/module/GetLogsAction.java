...
public class GetLogsAction extends Action {
  ...
  public GetLogsAction(List<String> modules, String version, String logFileLocation,
    ...
    // TODO(joaomartins): Something here isn't working. Command doesn't do anything.
