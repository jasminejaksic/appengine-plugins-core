...
public class StageActionTest {
  ...
  public void testCheckFlags() {
    ...
    // Just with a few flags.
    flags = ImmutableMap.of(Option.RUNTIME, "java");
    new StageAction(".", ".", ".", flags);
  }
  ...
  public void testGetAcceptedFlags() {
    Set<Option> acceptedFlags = ImmutableSet.of(
    ...
    StageAction action = new StageAction(".", ".", ".", ImmutableMap.<Option, String>of());

    assertEquals(acceptedFlags, action.getAcceptedFlags());
  }
}
